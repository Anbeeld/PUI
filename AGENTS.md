...
4. Update user documentation when commands, ownership, requirements, or behavior change. When adding or changing a PUI-owned patch, update the **Code, build, and compatibility changes** table in `README.md` and the detailed contract in `docs/patches.md`.
