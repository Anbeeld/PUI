...
export class NotificationManager implements NotificationSystem {
   ...
   */
  /** Deliver completions between parent turns, while consumption is still re-checkable. */
  ...
  private emitIndividualNudge(record: Subagent, deliverAs: "steer" | "followUp" = "followUp"): void {
    if (record.consumed) return;
