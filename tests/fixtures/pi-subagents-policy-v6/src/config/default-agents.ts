...
export const DEFAULT_AGENTS: Map<string, AgentConfig> = new Map([
  [
    "Worker",
    {
      ...
      toolGuideline: "- Worker: Use Worker for bounded execution after scope and approach are sufficiently decided. Give explicit ownership, constraints, success criteria, and validation. Parallel writers require disjoint ownership; do not parallelize overlapping write scopes.",
  ...
  [
    "Explore",
    {
      ...
      toolGuideline: "- Explore: Use Explore for local repository evidence. Give a specific question and breadth: quick, medium, or thorough. Parallelize independent investigations and do not repeat completed exploration without a concrete reason.",
